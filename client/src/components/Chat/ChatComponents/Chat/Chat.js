...
import {
  changeChatShow, setPreviewChatMode, changeShowModeCatalog, clearChatError, getPreviewChat,
...
class Chat extends React.Component {
  ...
  componentWillUnmount() {
    ...
    renderDialogList = () => {
      ...
      const {
        NORMAL_PREVIEW_CHAT_MODE, FAVORITE_PREVIEW_CHAT_MODE, BLOCKED_PREVIEW_CHAT_MODE, CATALOG_PREVIEW_CHAT_MODE,
      } = CONSTANTS;
      return (
        <div>
